...
#& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a12vk58hg73akk-ats.iot.ap-south-1.amazonaws.com --ca_file root-CA.crt --cert pub_sub.cert.pem --key pub_sub.private.key --client_id basicPubSub --topic sdk/test/python --count 0
& python .\publisher.py